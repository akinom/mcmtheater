...
char *progclass = "mcmTheater Screensaver Examples";
char *jarName;
char *className;

XrmOptionDescRec options [] = {
    { "-jdkhome", ".jdkhome", XrmoptionSepArg, 0 },
    { "-actor", ".actor", XrmoptionSepArg, 0 },
    { "-DELAY", ".DELAY", XrmoptionSepArg, 0 },
    { "-TRACE", ".TRACE", XrmoptionSepArg, 0 },
    { "-TRACEFILE", ".TRACEFILE", XrmoptionSepArg, 0 },
