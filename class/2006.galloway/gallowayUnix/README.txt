...
package, see see http://www.qsoptsolver.com/mcmTheater
================================================================================

mcmTheater screensaver README 
================================================================================

The Requirements and installation are the same as with any saverbeans screensaver. 
The sole difference is that saverbans-api.jar contains Sun's saverbeans classes
as well as mcmTheater classes; mcmTheaterSaverRes contains image files that need 
to be copied to the screensaver location, SCREENSAVER_BIN, along with *.jar files. 
Below find the information provided through Sun's readme: 
================================================================================
